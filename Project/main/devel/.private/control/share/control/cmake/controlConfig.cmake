...
if("TRUE" STREQUAL "TRUE")
  set(control_SOURCE_PREFIX /home/hrsd/project_workspace/Project/main/src/control)
  set(control_DEVEL_PREFIX /home/hrsd/project_workspace/Project/main/devel/.private/control)
  set(control_INSTALL_PREFIX "")
  set(control_PREFIX ${control_DEVEL_PREFIX})
else()
  set(control_SOURCE_PREFIX "")
  set(control_DEVEL_PREFIX "")
  set(control_INSTALL_PREFIX /home/hrsd/project_workspace/Project/main/install)
...
if(NOT "/home/hrsd/project_workspace/Project/main/devel/.private/control/include " STREQUAL " ")
  set(control_INCLUDE_DIRS "")
  set(_include_dirs "/home/hrsd/project_workspace/Project/main/devel/.private/control/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'yi <ge89vod@mytum.de>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hrsd/project_workspace/Project/main/src/control/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/hrsd/project_workspace/Project/main/devel/.private/control/lib;/home/hrsd/project_workspace/Project/main/devel/lib;/opt/ros/kinetic/lib)
