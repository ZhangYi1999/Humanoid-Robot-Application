...
public:
    ...
    // service client
    ros::ServiceClient move_joint_client = nh_.serviceClient <nao_control_tutorial_2::MoveJoints>("Movejoints");
    ...
    void imageCallBack(const sensor_msgs::ImageConstPtr& msg) 
    {
        ...
        my_tb.sendTransform(tf::StampedTransform(transform, ros::Time::now(), "CameraTop_optical_frame", "aruco_marker"));
...
int main(int argc, char** argv)
{
    ...
    my_NAO_ControlInstance.target_pos[0] = 0.0;
    my_NAO_ControlInstance.target_pos[1] = 0.0;
    my_NAO_ControlInstance.target_pos[2] = 0.0;
    my_NAO_ControlInstance.target_pos[3] = 0.0;
    my_NAO_ControlInstance.target_pos[4] = 0.0;
    my_NAO_ControlInstance.target_pos[5] = 0.0;
